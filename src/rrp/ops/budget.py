...
class RolePolicy:
    ...
    def host(cls) -> "RolePolicy":
        ...
        # D-036/D-086: user set the shared-disk reserve to a fixed 300 GB, later 100 GB (was max(20 GB, 10% of total) = ~367 GB here)
        return cls(0.8, 0.8, 0.5, disk_reserve_gib=100.0, disk_reserve_total_fraction=0.0)
