#!/usr/bin/env bash
# Track `binding`, whole-pipeline binding diversity (v3; v4 = v3 + B-1 fix zero_prev_action + anchored system 0): Stage A on paired scenes -> post-hoc probes ->
